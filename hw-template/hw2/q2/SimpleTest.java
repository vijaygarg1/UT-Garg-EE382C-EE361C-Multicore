...
//    }
    ...
    public void testAnderson2() {
        int result = q2.c.PIncrement.parallelIncrement(0, 4);
        System.out.println(result);
        Assert.assertEquals(result, OPERATIONS);
    }
    @Test
    public void testAnderson3() {
        int result = q2.c.PIncrement.parallelIncrement(0, 2);
        System.out.println(result);
        Assert.assertEquals(result, OPERATIONS);
    }
    @Test
    public void testAnderson4() {
        int result = q2.c.PIncrement.parallelIncrement(1, 8);
        System.out.println(result);
        Assert.assertEquals(result, OPERATIONS + 1);
    }
